...
CATALOG: List[Dict[str, str]] = [
    ...
    {"ticker": "CPLE3.SA","name": "Copel",              "klass": "br_acoes", "sector": "Eletrica",         "country": "BR", "currency": "BRL"},
    ...
    {"ticker": "JBSS32.SA","name": "JBS (BDR)",         "klass": "br_acoes", "sector": "Alimentos",        "country": "BR", "currency": "BRL"},
    {"ticker": "MBRF3.SA","name": "MBRF (Marfrig+BRF)", "klass": "br_acoes", "sector": "Alimentos",        "country": "BR", "currency": "BRL"},
    ...
    {"ticker": "BHIA3.SA","name": "Grupo Casas Bahia",  "klass": "br_acoes", "sector": "Varejo",           "country": "BR", "currency": "BRL"},
    # Saude
    ...
    # Azul (AZUL4) e Gol (GOLL4) sairam da B3 nas reestruturacoes de 2025/26 — equity extinto no Yahoo.
    {"ticker": "RAIL3.SA","name": "Rumo",               "klass": "br_acoes", "sector": "Logistica",        "country": "BR", "currency": "BRL"},
    {"ticker": "MOTV3.SA","name": "Motiva (ex-CCR)",    "klass": "br_acoes", "sector": "Logistica",        "country": "BR", "currency": "BRL"},
